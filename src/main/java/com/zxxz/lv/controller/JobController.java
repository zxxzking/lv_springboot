...
import com.zxxz.lv.job.BaseJob;
...
public class JobController {
    ...
    public Map<String, Object> queryjob(@RequestParam(value="pageNum")String className, @RequestParam(value="pageSize")String taskName)
    {
        Job job = jobService.getJob(className, taskName);
        Map<String, Object> map = new HashMap<String, Object>();
        map.put("JobAndTrigger", job);
        return map;
    }
